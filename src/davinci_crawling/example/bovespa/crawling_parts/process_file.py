...
_logger = logging.getLogger("davinci_crawler_{}.crawling_part.process_file".format(BOVESPA_CRAWLER))


def process_file(options, files_to_process, ccvm, doc_type, fiscal_date, version):
    ...
    company_file.update(status=FILE_STATUS_PROCESSED, thread_id=threading.currentThread().getName())
