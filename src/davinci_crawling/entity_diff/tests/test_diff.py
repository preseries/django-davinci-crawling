...
class TestDiff(CaravaggioBaseTest):
    ...
    def test_one_to_one_delete(self):
        ...
        expected = {
            ...
            "inserts": [],
            "updates": ["headquarters.country_code"],
            "deletes": []
        }
        ...
        expected = {
            ...
            "inserts": [],
            "updates": [],
            "deletes": ["headquarters.country_code"]
        }
    ...
    def test_one_to_many_update(self):
        ...
        expected = {
            ...
            "inserts": [],
            "updates": ["featured_team[0].ended_on"],
            "deletes": []
        }
    ...
    def test_insert_on_second_level_list(self):
        ...
        expected = {
            ...
            "inserts": ["investments[0].funding_round.is_series"],
            "updates": [],
            "deletes": []
        }
    ...
    def test_update_on_second_level_list(self):
        ...
        expected = {
            ...
            "inserts": [],
            "updates": ["investments[0].funding_round.announced_on"],
            "deletes": []
        }
    ...
    def test_delete_on_second_level_list(self):
        ...
        expected = {
            ...
            "inserts": [],
            "updates": [],
            "deletes": ["investments[0].funding_round.announced_on"]
        }
    ...
    def test_insert_on_second_level_object(self):
        ...
        expected = {
            ...
            "inserts": ["ipo.random_object.some"],
            "updates": [],
            "deletes": []
        }
